...
export default class CheckBox extends Component {
    constructor(props) {
        ...
        if (this.props.onChange) {
            this.props.onChange(this.props.id, this.props.content, this.props.isChecked);
        }
    }
    ...
    check(isChecked){
        if(isChecked != this.state.isChecked) {
            ...
            if (this.props.onChange) {
                this.props.onChange(this.props.id, this.props.content, isChecked);
            }
        }
    }
    ...
    getCheckedImage() {
        var source = this.state.isChecked ? require('../../assets/img/check-active.png') : require('../../assets/img/check-normal.png');
